function [nLL, Chi2, BIC, AIC, simulate_accuracy_rt, simulate_accuracy_choice] = LDDM_fit(params, dataBhvr)
...
% tic
[simulate_accuracy_rt, simulate_accuracy_choice, ~] = LDDM_GPU(Vprior, Vinput, w, a_accuracy, b_accuracy,...
...
% tic
[simulate_speed_rt, simulate_speed_choice, ~] = LDDM_GPU(Vprior, Vinput, w, a_speed, b_speed,...
    sgm, Tau, predur, dur, dt, presentt, triggert, thresh, initialvals, stimdur, stoprule, sims);
